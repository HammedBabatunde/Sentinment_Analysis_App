...
You will find the [url](https://sentimentsanalysedbybabatunde.azurewebsites.net/) for the deployed version of the app on the right-hand pane.
...
```
git clone https://github.com/HammedBabatunde/Sentinment_Analysis_App
cd Sentinment_Analysis_App
```
